      ...
      <div className="container">
        <div className="header">
          <div className="header_logo">
            <img width={40} height={40} src="/image/logo.png" alt="logo"></img>
        ...
        <div className="content">
          ...
          <div className="content_box">
            <div className="content_box_pizza">
              <img src="/image/Pizza.png" alt="pizza"></img>
              <p>Чизбургер-пицца</p>
              <div className="parameters">
                <ul className="corner">
                  <li className="active">тонкое</li>
                  <li className="inactive">традиционное</li>
                </ul>
                <ul className="size">
                  <li className="active">25 см.</li>
                  <li className="inactive">30 см.</li>
                  <li className="inactive">45 см.</li>
                </ul>
              </div>
              <div className="down">
                <p>от 395р.</p>
